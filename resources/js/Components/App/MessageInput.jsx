...
const MessageInput = ({conversation = null}) => {
    ...
    const onSendClick = () => {
        ...
        axios.post(route("message.store"), formData, {
            ...
            setInputErrorMessage(message || "Am error occurred while sending message")
        })
    }
    ...
    const recorderFileReady = (file, url) =>{
    ...
    return (
        <div className="flex flex-wrap items-start border-t border-slate-700 py-3">
            <div className="order-2 flex-1 xs:flex-none xs:order-1 p-2">
                ...
                <AudioRecorder fileReady={recorderFileReady}/>
            </div>
            <div className="order-1 px-3 xs:p-0 min-w-[220px] basis-full xs:basis-0 xs:order-2 flex-1 relative">
                ...
                {!!uploadProgress && (
                    <progress
                        className="progress progress-info w-full" value={uploadProgress} max="100">
            ...
            <div className="order-3 xs:order-3 p-2 flex">
                <Popover className="relative">
                    ...
                    <Popover.Panel theme="dark" className="absolute z-10 right-0 bottom-full">
                        <EmojiPicker onEmojiClick={ev => setNewMessage(newMessage + ev.emoji)}>
                        </EmojiPicker>
                    </Popover.Panel>
                </Popover>
